...
## Achievements
- National Finalist, Novartis Nest Challenge (Feb 2025): Built semantic search over 100k+ NIH clinical trials using NMF, BioBERT, and FAISS.
- Runner-up, Innov8 2.0 Hackathon (Sep 2024): Resume fraud detection and analytics dashboard for HR screening.
- Ranked 22 Nationally, Amazon ML Challenge (Sep 2024): OCR + vision models to extract entity names and values from images.

## Skills
- ML/AI: machine learning, deep learning, generative AI, data science
- Libraries: PyTorch, TensorFlow, Scikit-learn, Pandas, NumPy, SpaCy, NLTK, LangChain, LlamaIndex
- Languages: Python, C
...
## Links
- GitHub: https://github.com/nalllin
